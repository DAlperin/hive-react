      ...
      >
        ...
        >
          ...
          >
            <div
              id=""
              className={"panel-body panel-" + this.props.bdr.swipCode + "swip"}
            >
              {
                (
                  (
                    parseInt(this.props.bdr.swipCode) > 0
                  )
                  ?
                  (
                    "-" + this.props.bdr.swipCode + " SWIP(s): "
                  )
                  :
                  "Restored: "
                ) + 
                " " + this.props.bdr.problemBehavior + 
                " - (BDR-i" + this.props.bdr.entryID + 
                ".s" + this.props.bdr.studentUDID +
                ".a" + this.props.bdr.staffUDID +")"
              }
            </div>
          </div>
		      <BDRPanelTable
          ...
          >
            ...
            >
              ...
              <BDRComments
                comments={this.props.bdr.comments}
                bdr={this.props.bdr}
                restored={!(parseInt(this.props.bdr.swipCode) > 0)}
                viewerID={this.props.viewerID}
                viewer={this.props.viewer}
                updateBDRComments={this.props.updateBDRComments}
              />
