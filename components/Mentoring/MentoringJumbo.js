    ...
    return(
      ...
      >
        ...
        >
          <img
            height="100"
            src="./public/img/MentoringGraph.png"
          />
          {
            <span
              onClick={
          ...
          }
          {
            (
              ...
              ? ': ' + this.state.activeMentoring.title
              : ''
            )
          }
        </h1>
        {
          ...
          (
            ...
            >
              {
                this.props.mentees.map(
                  (mentee,id) => (
                    <li
                      className={
                        (this.state.activeMentoring.entryID == mentee.entryID)
                        ? 'active'
                        : ''
                      }
                      key={"mentoringnav" + mentee.entryID}
                      onClick={
                        this.getMentee(mentee)
                      }
                    >
                      <a
                        href="#"
