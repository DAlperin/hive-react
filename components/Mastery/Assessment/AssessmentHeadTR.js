            ...
            >
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={
                        function(e){
                          this.props.filterAssessmentStu(e.target.value)
                        }.bind(this)
                      }
                    />
                  </div>
              ...
              </td>
              {
                [0,1,2,3].map(
                  (id,index) => 
                  {
                    if(!!this.props.parsedAssessment
                        .AssessmentArrS[
                            Object.keys(
                              this.props.parsedAssessment.AssessmentArrS
                            )[
                        ...
                        return (
                          <AssessmentHeadTD 
                            key={
                              Object.keys(this.props.parsedAssessment.AssessmentArrS)[id+4*this.props.page]
                            }
                            mRecord={
                              (
                                !!this.props.parsedAssessment.AssessmentArrS
