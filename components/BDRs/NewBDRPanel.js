        ...
        >
          ...
          >
            ...
            >
              ...
              <select
                className="form-control bdrSel"
                id="bdrSelStu"
                onChange={
                  function(e){
                    this.updateNewBDRState('studentUDID',e.target.value)()
                  }.bind(this)
                }
                value={this.state.studentUDID}
              >
                {
                  studentList.map(
                    (student)=>(
                      <option
                        key={student.entryID}
                        value={student.entryID}
                      >
                        {student.name + ' (' + student.classNo + ')'}
                      </option>
                    )
                  )
                }
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('incidentDate',e.target.value)()
                  }.bind(this)
                }
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('incidentTimeH',e.target.value)()
                  }.bind(this)
                } 
                value={this.state.incidentTimeH}
              >
                {
                  hours.map(
                    (h,id)=>(
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('incidentTimeM',e.target.value)()
                  }.bind(this)
                }
                value={this.state.incidentTimeM}
              >
                {
                    minutes.map(
                    (m,id)=>(
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('location',e.target.value)()
                  }.bind(this)
                }
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('othersInvolved',e.target.value)()
                  }.bind(this)
                }
                value={this.state.othersInvolved}
              >
                {
                  studentList.map(
                    (student)=>(
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('problemBehavior',e.target.value)()
                  }.bind(this)
                }
                value={this.state.problemBehavior}
              >
                {
                  Object.keys(behaviors).map(
                    (beh,id)=>(
                      <option
                        key={id}
                      >
              ...
              <textarea
                className="form-control bdrTA"
                id="bdrTABehI"
                rows="5"
                onChange={
                  function(e){
                    this.updateNewBDRState('behaviorAnecdote',e.target.value)()
                  }.bind(this)
                }
                value={this.state.behaviorAnecdote}
              >
              </textarea>
              <span
                id="bdrPrevBehI"
              ...
              <select
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('possibleMotivation',e.target.value)()
                  }.bind(this)
                }
                value={this.state.possibleMotivation}
              >
                {
                  possiblemotivations.map(
                    (pm,id)=>(
                      <option
                        key={id}
                      >
              ...
              <textarea
                ...
                onChange={
                  function(e){
                    this.updateNewBDRState('teacherResponse',e.target.value)()
                  }.bind(this)
                }
